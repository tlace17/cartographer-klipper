...
curl -o /usr/data/printer_data/config/start_end.cfg https://github.com/K1-Klipper/cartographer-klipper/raw/master/start_end.cfg
...
curl -o /usr/data/printer_data/config/sensorless.cfg https://github.com/K1-Klipper/cartographer-klipper/raw/master/sensorless.cfg 
curl -o /usr/data/printer_data/config/carto_macro.cfg https://raw.githubusercontent.com/K1-Klipper/cartographer-klipper/master/cartographer_macro.cfg
